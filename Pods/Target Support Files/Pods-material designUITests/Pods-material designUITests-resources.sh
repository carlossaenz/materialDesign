...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_resource "MaterialComponents/components/ActivityIndicator/src/MaterialActivityIndicator.bundle"
  install_resource "MaterialComponents/components/AppBar/src/MaterialAppBar.bundle"
  install_resource "MaterialComponents/components/BottomNavigation/src/MaterialBottomNavigation.bundle"
  ...
  install_resource "MaterialComponents/components/Dialogs/src/MaterialDialogs.bundle"
